...
public class AllCustomersInfo extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    AllCustomersInfo frame = new AllCustomersInfo();
    ...
    public AllCustomersInfo() throws SQLException {
        super("All Customers Info");
