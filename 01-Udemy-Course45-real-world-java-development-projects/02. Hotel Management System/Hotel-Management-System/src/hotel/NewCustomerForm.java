...
public class NewCustomerForm extends JFrame {
    ...
    public NewCustomerForm() throws SQLException {
        ...
        // Form
            JLabel FormField01 = new JLabel("Document Type :");
            ...
            JLabel FormField02 = new JLabel("Customer Number :");
            ...
            try{
                ...
                while(rs.next()){
                    choice06.add(rs.getString("room_number"));    
                }
            }catch(Exception e){ }
            choice06.setBounds(271, 274, 150, 20);
            contentPane.add(choice06);
        ...
        JButton button01 = new JButton("Add");
        button01.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    String s6 = choice06.getSelectedItem();
                    ...
                    String q3 = "update room set clean_status = 'Used' where room_number = "+s6;
        ...
        button01.setBounds(100, 430, 120, 30);
        ...
        button02.setBounds(260, 430, 120, 30);
