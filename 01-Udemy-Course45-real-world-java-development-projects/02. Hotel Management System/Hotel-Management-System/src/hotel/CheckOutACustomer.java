...
public class CheckOutACustomer extends JFrame{
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    CheckOutACustomer frame = new CheckOutACustomer();
    ...
    public CheckOutACustomer() throws SQLException {
        super("Check Out a Customer");
